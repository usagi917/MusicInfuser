...
def create_pipeline(musicinfuser_path, mochi_dir):
    if musicinfuser_path == 'base':
...
def run_inference(args):
    ...
    try:
        ...
        pipeline = create_pipeline(args.musicinfuser_path, args.mochi_dir)
...
def main():
    ...
    parser.add_argument("--musicinfuser-path", type=str, 
                        default="weights/musicinfuser.safetensors", 
                        help="Path to the MusicInfuser model or 'base' for base model")
